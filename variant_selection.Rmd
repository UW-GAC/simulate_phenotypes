...
saveRDS(freq, file="/sbgenomics/output-files/freeze8_allele_freq_chr1_AfrAm_EurAm.rds")
```
...
Use LD prining to select independent variants. Prune first in pooled sample with MAF threshold 0.01, then in each population separately with no threshold.
